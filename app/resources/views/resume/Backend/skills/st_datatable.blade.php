    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h1 class="mt-4">Table Skills list</h1>
                <button class="btn btn-primary" onclick="window.location.href='/datatable/list/skills/create'">+
                    Create</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                "ajax": "{{ route('api.datatables.skills.data') }}",
                "columns": [{
                        "data": "id",
                        "title": "ID"
                    },
                    ...
                    },
                    {
                        ...
                        "title":"ลบ",
                        "render": function(data, type, row) {
                            return '<form action="{{ url('/datete/list/skills/') }}/' + row.id +
                                '" method="post">' +
                                '@csrf' +
                                '@method('DELETE')' +
