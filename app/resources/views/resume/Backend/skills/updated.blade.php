...
@section('content')
    <div class="container">
        ...
        <form action="{{route('datatables.skills.update',['id'=>$skills->id])}}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="header">Header</label>
                <input type="text" class="form-control" name="header" id="header" value="{{ $skills->header }}"
                    placeholder="ส่วนของ header">
            </div>

            <div class="form-group">
                <label for="contents">Contents</label>
                <input type="text" class="form-control" name="contents" id="contents" value="{{ $skills->contents }}"
                    placeholder="ส่วนของ contents">
            </div>
