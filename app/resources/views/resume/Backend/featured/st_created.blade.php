...
@section('content')
    <div class="container">
        ...
        <form action="{{route('datatables.list.featured.store')}}" method="post">
            @csrf
            <div class="form-group">
                <label for="header"></label>
                <input type="text" class="form-control" name="header" id="header" placeholder="ส่วนของ header" value="Interests & Hobbies" hidden >
            </div>

            <div class="form-group">
                <label for="head">หัวข้อย่อย</label>
