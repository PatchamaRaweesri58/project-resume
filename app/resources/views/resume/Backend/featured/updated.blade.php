...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{route('datatables.featured.update',['id'=>$featured->id])}}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="header">Header</label>
                <input type="text" class="form-control" name="header" id="header" value="{{$featured->header}}" placeholder="ส่วนของ header">
            </div>
