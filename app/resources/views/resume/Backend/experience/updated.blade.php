    ...
    <div class="container">
        ...
        <form action="{{route('datatables.experience.update',['id'=>$experience->id])}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="header" id="header" value="{{$experience->header}}" placeholder="ส่วนของ header">
            </div>

            <div class="form-group">
                <label for="head">Head</label>
                <input type="text" class="form-control" name="head" id="head" value="{{$experience->head}}" placeholder="ส่วนของ header">
            </div>

            <div class="form-group">
                <label for="contents">Contents</label>
                <input type="text" class="form-control" name="contents" id="contents" value="{{$experience->contents}}" placeholder="ส่วนของ contents">
            </div>
