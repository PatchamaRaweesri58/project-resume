...
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h1 class="mt-4">Table Experience-list</h1>
        <button class="btn btn-primary float-right" onclick="window.location.href='/datatables/list/experience/create'">+
            Create</button>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#myTable').DataTable({
                ...
                "serverSide": true,
                "pageLength": 10,
                "ajax": "{{ route('api.datatables.experience.data') }}",
                "columns": [{
                        "data": "id",
                        "title": "ID"
                    },
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return '<form id="deleteForm_' + row.id +
                                '" action="{{ url('/delete/list/experience/') }}/' + row.id +
                                '" method="post">' +
                                '@csrf' +
                                '@method('DELETE')' +
        ...
        function editProfile(id) {
            ...
            window.location.href = '/datatables/list/experience/edit/' + id;
        ...
        function confirmDelete(id) {
            if (confirm('Are you sure you want to delete this item?')) {
                ...
                fetch('{{ url('/delete/list/experience/') }}/' + id, {
                        method: 'DELETE',
                        headers: {
