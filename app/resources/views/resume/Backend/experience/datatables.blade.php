...
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <button class="btn btn-primary float-right" onclick="window.location.href='/datatables/experience/create'">+ Create</button>
    ...
    <script>
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return '<form id="deleteForm_' + row.id +
                                '" action="{{ url('/delete/experience/') }}/' + row.id +
                                '" method="post">' +
                                '@csrf' +
                                '@method('DELETE')' +
        ...
        function confirmDelete(id) {
            if (confirm('Are you sure you want to delete this item?')) {
                ...
                fetch('{{ url('/delete/experience/') }}/' + id, {
                        method: 'DELETE',
                        headers: {
