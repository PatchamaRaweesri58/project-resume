...
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h1 class="mt-4">Table Education</h1>
        <button class="btn btn-primary float-right" onclick="window.location.href='/datatables/education/create'">+
            Create</button>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#myTable').DataTable({
                ...
                "ajax": "{{ route('api.datatables.education') }}",
                "columns": [{
                        "data": "id",
                        "title": "ID"
                    },
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return '<form id="deleteForm_' + row.id +
                                '" action="{{ url('/delete/education/') }}/' + row.id +
                                '" method="post">' +
                                '@csrf' +
                                '@method('DELETE')' +
        ...
        function editProfile(id) {
            ...
            window.location.href = '/datatables/education/edit/' + id;
        ...
        //     } else {
        //         // ใส่ alert หรือสิ่งที่คุณต้องการทำเมื่อผู้ใช้ยกเลิกการลบที่นี่
