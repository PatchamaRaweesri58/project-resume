...
<div id="kt_app_header" class="app-header">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="javascript:;" class="d-lg-none me-5">
                {{-- <img alt="Logo" src="/backend/images/logos/lottery_logo3_short.png" class="h-35px" /> --}}
                <img alt="Logo" src="/images/logo-200x200.jpg" class="h-35px symbol symbol-circle" />
            </a>
        </div>
        <!--end::Mobile logo-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                                ...
                                <span class="menu-title">โทนสว่าง</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                ...
                                <span class="menu-title">โทนมืด</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('get-backend-user-me-change-pass') }}"
                                class="menu-link px-5">เปลี่ยนรหัสผ่าน</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('get-backend-logout') }}" class="menu-link px-5">ออกจากระบบ</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
